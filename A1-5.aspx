<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="A1-5.aspx.cs" Inherits="A1_5" %>
      ...
      <table class="auto-style1" style="background-color: #CCFFCC">
        <tr>
            <td class="auto-style6">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="標楷體" Font-Size="X-Large" ForeColor="#000099" Text="會員資料修改"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <br /></td>
            ...
            <td class="auto-style7">
                <div class="auto-style2">
                        ...
                        <asp:Label ID="Label3" runat="server" Height="25px" Text="角色" Font-Bold="True" Font-Size="Large" ForeColor="#0033CC"></asp:Label>
                                ...
                                <td class="auto-style14"><asp:DropDownList ID="ddlroletype" runat="server" DataSourceID="dsRoleType" DataTextField="roletypeDescription" DataValueField="roletype" Font-Size="Medium">
                        </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style13"> <asp:TextBox ID="txtEmail" runat="server" Height="20px" Width="239px" Font-Bold="True" Font-Size="Medium" ForeColor="#0033CC" CssClass="auto-style5"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="auto-style13"> <asp:TextBox ID="txtPassword" runat="server" Height="20px" Width="167px" Font-Bold="True" Font-Size="Medium" ForeColor="#0033CC"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="btnInforChange" runat="server" OnClick="btnInforChange_Click" Text="修改" Width="117px" Font-Size="Medium" />
                        <br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
