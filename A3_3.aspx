<%@ Page Title="" Language="C#" MasterPageFile="~/Site3.master" AutoEventWireup="true" CodeFile="A3_3.aspx.cs" Inherits="A3_3" %>
...
<table class="tableStyle" style="background-color: #CCFFCC">
        <tr>
            <td colspan="2" style="text-align: left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="標楷體" Font-Size="X-Large" ForeColor="#000099" Text="查看個人審查意見"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td style="vertical-align: top" rowspan="2">
                    <asp:Label ID="Label30" runat="server" Font-Bold="True" Font-Names="標楷體" Font-Size="X-Large" ForeColor="#000099" Text="已審核清單"></asp:Label>
                        ...
                        <asp:SqlDataSource ID="dsMediaUploadForJudging" runat="server" ConnectionString="<%$ ConnectionStrings:OTTConnectionString %>" SelectCommand="SELECT MediaUpload.MCID, MediaUpload.MCYouTubeURL, MediaUpload.MCTitle, MediaUpload.MCCreatedDate, MediaUpload.MCOrgStatus, ReviewDetail.MCOrgStatus as MyMCOrgStatus, ReviewDetail.dresult, ReviewDetail.dreview, Person.PName FROM MediaUpload INNER JOIN ReviewDetail ON MediaUpload.MCID = ReviewDetail.mcid INNER JOIN Person ON MediaUpload.PID = Person.PID WHERE (ReviewDetail.pid = @PID) AND (ReviewDetail.dresult &lt;&gt; -1)">
                            <SelectParameters>
            ...
            <td style="vertical-align: top">
                 <table style="background-color: #CCFFCC">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtdreview" runat="server" Height="76px" Width="295px" TextMode="MultiLine"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
