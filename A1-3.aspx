<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.master" AutoEventWireup="true" CodeFile="A1-3.aspx.cs" Inherits="A1_3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">   
    <table class="tableStyle" style="background-color: #CCFFCC">
        <tr>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="標楷體" Font-Size="X-Large" ForeColor="#000099" Text="審核結果查詢"></asp:Label>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td style="vertical-align: top">
                        <asp:GridView ID="gvVideo" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="dsMediaUpload" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="gvVideo_SelectedIndexChanged" AllowPaging="True" DataKeyNames="MCID,dreview,dresult,DMCOrgStatus,mreview,mresult,MMCOrgStatus" Width="490px">
